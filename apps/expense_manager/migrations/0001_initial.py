# Generated by Django 3.2 on 2023-06-22 17:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('products', '0004_historicalcategoryproduct_historicalindicator_historicalmeasureunit_historicalproduct'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_name', models.CharField(max_length=150, verbose_name='Razon Social')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateField(auto_now=True, verbose_name='Fecha de actualizacion')),
                ('deleted_date', models.DateField(auto_now=True, verbose_name='Fecha de Eliminacion')),
                ('date', models.DateField(verbose_name='Fecha de emision de Merma')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateField(blank=True, editable=False, verbose_name='Fecha de actualizacion')),
                ('deleted_date', models.DateField(blank=True, editable=False, verbose_name='Fecha de Eliminacion')),
                ('date', models.DateField(verbose_name='Fecha de emision de factura')),
                ...
                ('voucher_number', models.CharField(max_length=50, verbose_name='Numero de comprobante')),
                ...
                ('product', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='products.product')),
                ('provider', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='expense_manager.supplier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.product')),
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='expense_manager.supplier')),
